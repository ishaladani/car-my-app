...
//         // Store garage data for renewal page
...
//       // Store token and user type in localStorage for successful login
...
const LoginPage = () => {
  ...
  useEffect(() => {
    ...
    if (token && userType && garageId) {
      ...
      // Set the login type based on stored userType
      ...
      >
        ...
        >
          ...
          {isLoggedIn && (
            ...
            >
              You are already logged in as {currentUser?.userType === 'garage' ? 'Garage' : 'User'}. 
