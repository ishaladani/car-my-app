...
//   const garageToken = localStorage.getItem('token'); // Assuming token is stored here
...
//     quantity: 1,
//     pricePerUnit: 0,
//     gstPercentage: 0, // Changed from taxAmount to gstPercentage
//     taxAmount: 0 // Keep for backward compatibility
//   });
...
//   // Fixed fetchTasks function - replace the existing one in your component
...
//     // Show info message if no tasks are available
...
//     // Set empty array instead of fallback tasks when API fails
//     setAvailableTasks([]);
//   } finally {
//     setIsLoadingTasks(false);
//   }
// }, [garageToken, navigate, apiCall]);
...
//         // Fallback parsing for duration strings
...
//           gstPercentage: part.gstPercentage || 0, // Add GST percentage
...
//             // If part exists, increase quantity
//             allPartsUsed[existingPartIndex].quantity += selectedQuantity;
//           } else {
//             // Add new part with enhanced data
//             allPartsUsed.push({
//               partId: part._id,
//               partName: part.partName,
//               partNumber: part.partNumber || '',
...
//               pricePerUnit: part.pricePerUnit || 0,
//               gstPercentage: part.gstPercentage || part.taxAmount || 0, // Use gstPercentage or fallback to taxAmount
//               carName: part.carName || '',
//               model: part.model || ''
//             });
//           }
...
//       // Update job cards with parts used (for each job card in jobCardIds)
...
//         getOptionLabel={(option) => 
//           `${option.partName} (${option.partNumber || 'N/A'}) - ₹${option.pricePerUnit} | GST: ${option.gstPercentage || option.taxAmount || 0}% | Available: ${option.quantity}`
//         }
//         value={assignment.parts}
//         onChange={(event, newValue) => {
//           // Add quantity property to newly selected parts
...
//             <Chip
//               variant="outlined"
//               label={`${option.partName} (${option.partNumber || 'N/A'}) - Qty: ${option.selectedQuantity || 1} @ ₹${option.pricePerUnit}`}
//               {...getTagProps({ index })}
//               key={option._id}
//             />
//           ))
