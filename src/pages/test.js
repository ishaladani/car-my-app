                    ...
                    <Table>
                      <TableHead>
                        <TableRow sx={{ bgcolor: theme.palette.mode === 'dark' ? 'rgba(255,255,255,0.05)' : '#f8fafc' }}>
                          <TableCell sx={{ fontWeight: 600, color: 'text.secondary' }}>Sr.No.</TableCell>
                          <TableCell sx={{ fontWeight: 600, color: 'text.secondary' }}>Part Name</TableCell>
              ...
              >
                ...
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Box sx={{ mb: 2 }}>
                    ...
                    <Typography variant="body1" fontWeight={500} color="text.primary">
                      {insuranceDetails.expiry ? new Date(insuranceDetails.expiry).toLocaleDateString() : 'N/A'}
                    </Typography>
                  </Box>
                  <Divider sx={{ my: 2 }} />
                  <Box>
              ...
              >
                ...
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Box>
                    ...
                    <Typography variant="body1" fontWeight={500} color="text.primary">
                      {engineerDetails.assignedDateTime ? new Date(engineerDetails.assignedDateTime).toLocaleString() : 'N/A'}
                    </Typography>
                  </Box>
                </CardContent>
              </Card>
