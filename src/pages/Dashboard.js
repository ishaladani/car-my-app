  ...
  useEffect(() => {
    const fetchJobs = async () => {
      ...
      try {
        ...
        const activeJobsCount = jobsData.filter(job => 
                        ...
                        <TableBody>
                          {currentJobs.map((job) => (
                            <TableRow key={job._id}>
                              ...
                              <TableCell>{job.jobDetails || job.type || 'General Service'}</TableCell>
                              <TableCell>
                                <Box
                                  sx={{
                                    display: "flex",
                              ...
                              <TableCell><Button onClick={() =>handleUpdate(job._id)}>Update</Button></TableCell>
                            </TableRow>
                          ))}
                        </TableBody>
                      </Table>
