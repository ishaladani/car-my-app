...
//         // Helper function to ensure content doesn't get split awkwardly
//         const checkSectionBreak = (sectionHeight) => {
...
//         // Check if we need a new page for the entire summary section
//         const summaryHeight = 100; // Estimated height including notes and payment info
...
//         // Full width summary section for better layout
...
//             ['CGST (9%):', formatAmount(halfGst)],
//             ['SGST (9%):', formatAmount(halfGst)],
...
//         doc.setFont('helvetica', 'bold');
//         doc.setTextColor(255, 255, 255);
//         doc.text('TOTAL AMOUNT:', leftColX, currentY + 8);
...
//         // Create mailto link (note: PDF attachment may not work in all email clients)
...
//         // Also trigger PDF download as backup
//         downloadPdfBill();
