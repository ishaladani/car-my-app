...
// // Note: Make sure jspdf-autotable is installed: npm install jspdf-autotable
// // import 'jspdf-autotable'; // Uncomment this line after installing the package
...
//                 if (data) {
//                     setCarDetails({
//                         carNumber: data.carNumber || "ABO-123",
//                         company: data.carBrand || "Toyota",
//                         model: data.carModel || "Corolla",
//                         customerName: data.customer?.name || "John Smith",
//                         contact: data.customer?.contact || "7990879645",
//                         email: data.customer?.email || "john@example.com",
//                         billingDate: today,
...
//                         pricePerUnit: parseFloat(part.pricePerPiece) || 0,
...
//                 // Populate services if available
//                 if (data.services && data.services.length > 0) {
//                     const existingServices = data.services.map((service, index) => ({
//                         id: index + 1,
//                         name: service.serviceName || service.name || '',
//                         engineer: service.engineer || 'Assigned Engineer',
...
//                 // Set email recipient to customer email if available
...
//     // Enhanced PDF generation function with fallback
...
//             // Parts section - Manual table creation
//             doc.setFontSize(11);
//             doc.setFont('helvetica', 'bold');
...
//             // Generate PDF as base64 - FIXED: using correct function name
//             const doc = generatePdfInvoice();
...
const processOnlinePayment = async () => {
    ...
    try {
        ...
        const paymentResponse = await axios.post(
            "https://garage-management-system-cr4w.onrender.com/api/billing/pay",
            {
                billId: billId,
