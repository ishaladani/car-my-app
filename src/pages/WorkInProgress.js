...
//           const qty = parseFloat(updatedPart.qty) || 0;
//           const price = parseFloat(updatedPart.pricePerPiece) || 0;
          
//           // Calculate total price (qty * price)
//           updatedPart.totalPrice = (qty * price).toFixed(2);
//         }
